...
namespace Parser
{
	...
	enum class SubType {
		...
		MOVE, MOVEOUT, ACTION, ATTACK, HIT, DAMAGE, SPAWN, PSPAWN, ASKRESPAWN, RESPAWN, DESPAWN, PICKUP, PLAYERINFO,
	...
	const static std::string subTypeNames[] = { "SUBERROR", "NEWPLAYER", "INITPLAYER", "DISCPLAYER", "VOTE", "TIMEOUT", "TIMEOUTANSWER",
		"MOVE", "MOVEOUT", "ACTION", "ATTACK", "HIT", "DAMAGE", "SPAWN","PSPAWN", "ASKRESPAWN", "DESPAWN", "PICKUP", "PLAYERINFO",
